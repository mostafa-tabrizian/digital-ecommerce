...
const CourseCards = ({ course }: { course: ICourse }) => {
   const status = {
      comingSoon: 'به زودی',
      ...
      <>
         <div className='p-2 my-5 ltr shadow-lg bg-white relative flex flex-col rounded-xl'>
            ...
            <div className='space-y-3 text-right'>
               <Link href={'/course/' + course.name}>
                  <span className='text-lg yekanBlack hover:text-blue-600 transition-all duration-500 ease-in-out'>
                     {course.name}
                  </span>
                  ...
                  <div className='flex justify-end gap-x-6 items-center mb-3'>
                     ...
                     <div className='flex items-center gap-x-1 text-slate-600'>
                        <span className='text-xs'>{courseLength()}</span>
                        <svg
                           xmlns='http://www.w3.org/2000/svg'
                           viewBox='0 0 24 24'
                           fill='none'
                  ...
                  <div className='cursor-pointer'>
                     <span className='flex justify-end items-center transition-all duration-300 text-blue-500 hover:text-blue-900 gap-x-2 text-base font-bold'>
