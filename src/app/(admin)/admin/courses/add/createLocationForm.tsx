...
const CreateLocationForm = ({ selectedCourse }: { selectedCourse: string | null }) => {
   const onSubmit = async (values: {
      ...
      const payload = { ...values, courseId: selectedCourse }

      if (!selectedCourse) return toast.warning('هیچ محصولی انتخاب نشده است!')

      try {
         const res = await fetch('/api/course/location', {
            method: 'POST',
