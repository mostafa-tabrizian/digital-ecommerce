      ...
      <div className='m-3'>
         ...
         <div className='rounded-xl p-3 mb-6 lg:p-5 bg-white'>
            <div className='flex flex-col items-center'>
               ...
               <p className='justify-center leading-6 text-right py-2 text-sm text-slate-600'>
                  من بسیار خرسندم که در این سفر یادگیری، راهنمای شما خواهم بود. با تجربیات زیادی که
                  در زمینه تدریس داشته‌ام، معتقدم که یادگیری باید یک تجربه شگفت‌انگیز و پر از انگیزه
                  باشد. من به عنوان مربی شما، تلاش خواهم کرد که با ارائه محتوای جذاب و فعّال، هر درس
                  را به یک سفر شگفت‌انگیز تبدیل کنم. در این دوره آموزشی، نه تنها قصد دارم به شما
                  مفاهیم ضروری را یاد بدهم بلکه با ارائه تمرینات عملی و فعّال، مهارت‌های شما را نیز
                  تقویت کنم. من معتقدم که هر دانشجو می‌تواند با اجتناب از روش‌های کسل‌کننده و با
                  استفاده از رویکردهای نوین یادگیری، به بهترین شکل ممکن به مهارت‌های مورد نیاز برسد.
                  من منتظرم که این سفر مشترک ما، پر از چالش‌ها و پیشرفت‌های جذاب باشد. برای هرگونه
                  سوال یا نیاز به کمک، همیشه در دسترس شما خواهم بود. بیایید با هم به دنیای جدیدی از
                  دانش نفوذ کنیم و با هم به سوی موفقیت حرکت کنیم
               </p>
            </div>
         </div>
         ...
         <div id='description' className='bg-white rounded-xl mt-6 p-3 lg:p-6'>
            ...
            <div className='text-right'>
               ...
               <div>
                  <h3 className='yekanBlack mt-10 mb-5 text-lg text-gray-800'>چرا زبان انگلیسی؟</h3>
                  <p className='text-gray-700 leading-10 tracking-wide rtl'>
                     ...
                     در دنیای امروز، انگلیسی زبان جهانی است. این زبان افراد را قادر می‌سازد با جوانب
                     مختلف جهان در ارتباط باشند.
                     <br />
                     <h3 className='yekanBlack mt-10 mb-5 text-lg text-gray-800'>فرصت‌های شغلی</h3>:
                     بسیاری از شرکت‌ها از انگلیسی برای ارتباطات استفاده می‌کنند. یادگیری این زبان به
                     افراد کمک می‌کند تا در بازار کار جهانی موفق‌تر باشند.
                     <br />
                     <h3 className='yekanBlack mt-10 mb-5 text-lg text-gray-800'>
                        دسترسی به منابع تخصصی
                     </h3>
                     بسیاری از منابع تخصصی جهان به انگلیسی نوشته شده‌اند. این زبان به افراد این
                     امکان را می‌دهد که به دانش بین‌المللی دسترسی داشته باشند.
                     <br />
                     <h3 className='yekanBlack mt-10 mb-5 text-lg text-gray-800'>
                        تسهیل در تحصیلات بین‌المللی
                     </h3>
                     برنامه‌های تحصیلی جهانی به زبان انگلیسی ارائه می‌شوند. یادگیری این زبان افراد
                     را در شرکت در دوره‌ها و دانشگاه‌های بین‌المللی یاری می‌کند.
                  </p>
               </div>
            </div>
         </div>
