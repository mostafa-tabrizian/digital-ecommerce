         ...
         <div className='rounded-xl p-3 mb-6 lg:p-5 bg-white'>
            <div className='flex flex-col items-center'>
               ...
               <p className='justify-center leading-6 text-right py-2 text-sm text-slate-600'>
                  ...
                  (رشته مهندسی نفت) زبان انگلیسی میکردم. کم کم با MATLAB آشنا شدم و بعدا وارد حوزه
                  زبان انگلیسی وب شدم و الان حدود 7 ساله که شغل تخصصی من زبان انگلیسی وب هست.
                  <strong> علاقه من جاوااسکریپت و خاندانش است. </strong>به همین دلیل اکسپرسیفای
