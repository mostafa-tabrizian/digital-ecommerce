const SuggestionStatus = ({ suggestion }: { suggestion: null | boolean }) => {
   return (
      <div className='mb-4'>
         {suggestion ? (
         ...
         {suggestion == null ? (
            <p className='flex items-center text-sm lg:text-base gap-1 text-gray-500'>
               <svg
                  stroke='currentColor'
                  fill='none'
                  strokeWidth='2'
         ...
         {suggestion == false ? (
            <p className='flex items-center text-sm lg:text-base gap-1 text-rose-500'>
               <svg
                  stroke='currentColor'
                  fill='currentColor'
                  strokeWidth='0'
